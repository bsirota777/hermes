...
// Logic here is essentially unchanged from the pre-split monolith (Parcel and Delivery both still
// live in delivery-service, so the JPA relation between them didn't need to change) - ported as-is.
...
class ParcelServiceTest {
    ...
    private CreateParcelRequestDto buildValidRequest(Long deliveryId) {
        ...
        request.setDescription("Test parcel");
    ...
    void createParcel_savesParcel_whenDeliveryExists() {
        ...
        assertThat(result.getDescription()).isEqualTo("Test parcel");
    }
