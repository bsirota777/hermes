...
import com.hermes.delivery.TestcontainersConfig;
...
// Simplified from the pre-split version: Delivery no longer needs a persisted sender/recipient
// User+SenderProfile/RecipientProfile chain to save (those live in profile-service now) - just
// plain senderId/recipientId Longs, same as DeliveryRepositoryTest.
@DataJpaTest
...
class ParcelRepositoryTest {
    ...
    private Delivery persistDelivery() {
    ...
    void findByDeliveryId_returnsAllParcelsForDelivery() {
        Delivery delivery = persistDelivery();
